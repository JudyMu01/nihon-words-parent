package org.dan.nihonwords.common.constant;

/**
 * @author mcd
 * @create 2024-08-31 21:35
 */
public class MqConst {
     ...
     * 商品上下架
     */
    public static final String EXCHANGE_GOODS_DIRECT = "nihonwords.word.direct";
    public static final String ROUTING_GOODS_UPPER = "nihonwords.word.upper";
    public static final String ROUTING_GOODS_LOWER = "nihonwords.word.lower";
    //队列
    public static final String QUEUE_GOODS_UPPER  = "nihonwords.word.upper";
    public static final String QUEUE_GOODS_LOWER  = "nihonwords.word.lower";
