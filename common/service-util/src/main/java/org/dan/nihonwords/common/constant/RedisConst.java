...
public class RedisConst {
    ...
    //单词学习
    public static final String STUDY_PENDING_KEY_SUFFIX = ":pendingwords";
    public static final String STUDY_LEARNED_KEY_SUFFIX = ":learnedwords";
